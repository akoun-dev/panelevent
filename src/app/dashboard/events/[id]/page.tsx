            ...
            <CardContent className="space-y-4">
              {event.program?.hasProgram ? (
                <div className="space-y-4">
                  ...
                  {event.program.programText && (
                    <div className="prose prose-sm max-w-none">
                      <div
                        dangerouslySetInnerHTML={{ __html: event.program.programText }}
                        className="border rounded-lg p-4 bg-muted/50 mb-6"
                      />
                    </div>
                  )}
                  ...
                  {event.program.programItems && event.program.programItems.length > 0 && (
                    <div className="space-y-3">
                      ...
                      {event.program.programItems.map((item) => (
                  ...
                  {/* Message si aucun contenu de programme */}
                  {!event.program.programText && (!event.program.programItems || event.program.programItems.length === 0) && (
                    <div className="text-center py-8 text-muted-foreground">
                      <Calendar className="w-12 h-12 mx-auto mb-4 opacity-50" />
                      <p className="text-lg font-medium mb-2">Programme vide</p>
                      <p className="text-sm">Ajoutez du contenu à votre programme</p>
                    </div>
                  )}
                </div>
              ) : (
